            ...
            <div class="card-header">
                <div class="d-flex align-items-center">
                    <div class="col">
                        ...
                        <span>Penginputan Data Kelompok</span>
                    </div>
                        ...
                        <div class="modal-content">
                            <div class="modal-header border-0">
                                <h5 class="modal-title">
                                    <span class="fw-mediumbold">Input Data Kelompok</span>
                                </h5>
                            </div>
                            <div class="modal-body">
                                <form action="{{ url('/kelompok') }}" method="POST" id="addRowForm"
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="alamat" name="alamat"
                                                    placeholder="* isi Alamat Masjid Kelompok" />
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-button-action">
                                        ...
                                        <div class="modal fade" id="editModal{{ $data->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ url('/kelompok/edit/'. $data->id) }}"
                                        ...
                                        <a href="{{ url('/kelompok/delete/'. $data->id) }}" type="button" title="Hapus"
