                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-4 d-flex gap-3">
                      <div class="form-group">
                        ...
                        <div class="input-group-text">
                          <input type="hidden" name="humBapak" class="humBapakVal" value="0">
                          <input class="form-check-input mt-0 humBapak" type="checkbox" value="0"
                    ...
                    <div class="col-sm-4 d-flex gap-3">
                      <div class="form-group">
                        ...
                        <div class="input-group-text">
                          <input type="hidden" name="humIbu" class="humIbuVal" value="0">
                          <input class="form-check-input mt-0 humIbu" type="checkbox" value="0"
                            aria-label="Checkbox for following text input">
                        </div>
                      </div>
                    </div>
              ...
              <tr>
                ...
                <td>
                  <div class="form-button-action">
                    <button type="button" data-bs-toggle="modal" data-bs-target="#editModal{{ $ortu->id }}"
                      title="Edit" class="btn btn-link btn-primary" data-original-title="Edit Task"
                      style="padding: 10px">
                      <i class="fa fa-edit"></i>
                    </button>

                    <!-- Modal -->
                    <div class="modal fade" id="editModal{{ $ortu->id }}" tabindex="-1" role="dialog"
                      aria-hidden="true">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header border-0">
                          ...
                          <div class="modal-body">
                            <form action="{{ url('/ortu/edit/'. $ortu->id) }}" method="POST"
                              id="editRowForm{{ $ortu->id }}" class="row g-3" enctype="multipart/form-data">
                              @csrf
                              <div class="row">
                                <div class="col-sm-8">
                                  <div class="form-group">
                                    <label for="namabapak">Nama Bapak</label>
                                    <input type="text" name="namabapak" class="form-control form-control"
                                      placeholder="* isi Nama Bapak" value="{{ $ortu->nama_bapak }}" required />
                                  </div>
                                </div>
                                <div class="col-sm-4 d-flex gap-3">
                                  <div class="form-group">
                                    ...
                                    <div class="input-group-text">
                                      <input type="hidden" name="humBapak" class="humBapakVal" value="0">
                                      <input class="form-check-input mt-0 humBapak" type="checkbox" value="0"
                                        aria-label="Checkbox for following text input" @if($ortu->hum_bapak == 1)
                                      checked @endif>
                                    </div>
                                  </div>
                                </div>
                                <div class="col-sm-8">
                                  <div class="form-group">
                                    <label for="namaibu">Nama Ibu</label>
                                    <input type="text" class="form-control form-control" name="namaibu" id="namaibu"
                                      placeholder="* isi Nama Ibu" value="{{ $ortu->nama_ibu }}" required />
                                  </div>
                                </div>
                                <div class="col-sm-4 d-flex gap-3">
                                  <div class="form-group">
                                    ...
                                    <div class="input-group-text">
                                      <input type="hidden" name="humIbu" class="humIbuVal" value="0">
                                      <input class="form-check-input mt-0 humIbu" type="checkbox" value="0"
                                        aria-label="Checkbox for following text input" @if($ortu->hum_ibu == 1) checked
                                      @endif>
                                    </div>
                                  </div>
                                </div>
                                <div class="col-sm-12">
                                  <div class="form-group">
                                    <label for="alamat">Alamat</label>
                                    <input type="text" class="form-control form-control" name="alamat" id="alamat"
                                      placeholder="* isi Alamat Lengkap" value="{{ $ortu->alamat }}" required />
                                  </div>
                                </div>
                                <div class="col-md-12">
                                  <div class="form-group">
                                    <label for="nohp">No Telp</label>
                                    <input type="text" class="form-control form-control" name="nohp" id="nohp"
                                      placeholder="* isi No Telp" value="{{ $ortu->nohp }}" required />
                                  </div>
                                </div>
                                <div class="col-md-12">
                                  <div class="form-group">
                                    ...
                                    <select class="form-select form-control" name="kelompok" id="kelompok" required>
                                      <option value="" selected disabled>Pilih Kelompok</option>
                                      @foreach ($kelompoks as $kelompok)
                                      <option value="{{ $kelompok->id }}" @if($kelompok->id == $ortu->id_kelompok)
                                        selected @endif>{{ $kelompok->nama }}</option>
                                      @endforeach
                                    </select>
                                  </div>
                                </div>
                          ...
                          <div class="modal-footer border-0">
                            <button type="button" onclick="editRow({{ $ortu->id }})" class="btn btn-primary">
                              Add
                            </button>
                            <button type="button" id="" class="btn btn-danger cancelRowButton" data-dismiss="modal">
                              Close
                            </button>
                          </div>
                        </div>
                    ...
                    <a href="{{ url('/ortu/delete/'. $ortu->id) }}" type="button" title="Hapus"
